            ...
            <div className='mx-auto max-w-[1920px] px-4 md:px-8 2xl:px-16'>
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-5 md:gap-9 xl:gap-5 pb-9 md:pb-14 lg:pb-16 2xl:pb-20 3xl:pb-24 lg:mb-0.5 2xl:mb-0 3xl:-mb-1'>
                    ...
                    <div className='pb-3 md:pb-0'>
                        ...
                        <ul className='text-xs lg:text-sm text-body flex flex-col space-y-3 lg:space-y-3.5'>
                            <li className='flex items-baseline'>
                                <a className='transition-colors duration-200 hover:text-black' href='/contact-us'>
                                    Contact Us
                                </a>
                            </li>
                            <li className='flex items-baseline'>
                                <a className='transition-colors duration-200 hover:text-black' href='/'>
                    ...
                    <div className='pb-3 md:pb-0'>
                        ...
                        <ul className='text-xs lg:text-sm text-body flex flex-col space-y-3 lg:space-y-3.5'>
                            <li className='flex items-baseline'>
                                <a className='transition-colors duration-200 hover:text-black' href='/faq'>
                                    FAQ &amp; Helps
                                </a>
                            </li>
                            <li className='flex items-baseline'>
                    ...
                    <div className='pb-3 md:pb-0'>
                        ...
                        <ul className='text-xs lg:text-sm text-body flex flex-col space-y-3 lg:space-y-3.5'>
                            <li className='flex items-baseline'>
                                <a className='transition-colors duration-200 hover:text-black' href='/privacy'>
                                    Privacy policy update
                                </a>
                            </li>
                            <li className='flex items-baseline'>
                                <a className='transition-colors duration-200 hover:text-black' href='/terms'>
                                    Terms &amp; conditions
                                </a>
                            </li>
                            <li className='flex items-baseline'>
                    ...
                    <div className='pb-3 md:pb-0'>
                        ...
                        <ul className='text-xs lg:text-sm text-body flex flex-col space-y-3 lg:space-y-3.5'>
                            <li className='flex items-baseline'>
                                <a className='transition-colors duration-200 hover:text-black' href='/search'>
                                    Men's Wear
                                </a>
                            </li>
                            <li className='flex items-baseline'>
